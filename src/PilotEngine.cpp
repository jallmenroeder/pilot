...
// unit cube (no sensible data in normals and uv, just for testing)
const std::vector<Vertex> VERTICES = {
        {{-0.5f, -0.5f, -0.5f}, glm::normalize(glm::vec3(1.0f, 0.0f, 0.0f)), {0., 0.}},
        {{0.5f, -0.5f, -0.5f}, glm::normalize(glm::vec3(0.0f, 1.0f, 0.0f)), {1., 0.}},
        {{0.5f, 0.5f, -0.5f}, glm::normalize(glm::vec3(0.0f, 0.0f, 1.0f)), {1., 1.}},
        {{-0.5f, 0.5f, -0.5f}, glm::normalize(glm::vec3(1.0f, 1.0f, 1.0f)), {0., 1.}},
        {{-0.5f, -0.5f, 0.5f}, glm::normalize(glm::vec3(1.0f, 0.0f, 0.0f)), {1., 1.}},
        {{0.5f, -0.5f, 0.5f}, glm::normalize(glm::vec3(0.0f, 1.0f, 0.0f)), {0., 1.}},
        {{0.5f, 0.5f, 0.5f}, glm::normalize(glm::vec3(0.0f, 0.0f, 1.0f)), {0., 0.}},
        {{-0.5f, 0.5f, 0.5f}, glm::normalize(glm::vec3(1.0f, 1.0f, 1.0f)), {1., 1.}}
};
